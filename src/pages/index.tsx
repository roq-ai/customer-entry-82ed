  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Customer Entry - Streamlining your employee data entry process for a more efficient and productive workplace."
        />
      </Head>
      ...
      <Stack minH={'100vh'} direction={{ base: 'column', md: 'row' }}>
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack position="relative" spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              {`Welcome to Customer Entry - Streamlining your employee data entry process for a more efficient and productive workplace.`}
            </Text>
        ...
        <Flex position="relative" flex={1}>
          <Image
            src={
              'https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxlbXBsb3llZSUyQ2RhdGElMjBlbnRyeXxlbnwwfHx8fDE2ODg2NzQ1Mjl8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt={'Login Image'}
            objectFit={'cover'}
          />
